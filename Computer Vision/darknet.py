...
if os.name == "nt":
    ...
    lib = CDLL("./libdarknet.so", RTLD_GLOBAL)
    print("libdarknet.so is found and loaded")
...
def detect(net, meta, image, thresh=.5, hier_thresh=.5, nms=.45, debug= False):
    ...
    # print("this is the image type: ", type(im), " meta type: ", type(meta), " this is the meta: ", meta)
    if debug: print("Loaded image")
    im2, _ = array_to_image(image)
    ret = detect_image(net, meta, im2, thresh, hier_thresh, nms, debug)
    #free_image(im2)
...
def performDetect(imagePath="./2748.jpg", thresh= 0.25, configPath = "./yolov3_obj.cfg", weightPath = "./yolov3_obj.weights", metaPath= "./obj.data", showImage= False, makeImageOnly = False, initOnly= False):
    """
...
def performBatchDetect(thresh= 0.25, configPath = "./yolov3.cfg", weightPath = "./yolov3.weights", metaPath= "./obj.data", hier_thresh=.5, nms=.45, batch_size=3):
    import cv2
    import numpy as np
